...
class PiDDecode:
    ...
    def decode(
        ...
        # Decode the low-res baseline first, then release Comfy's Z-Image/TE/VAE models
        # before loading/running PiD. This is important on 16GB cards.
